  ...
  return (
    <div className='flex flex-col justify-between'>
      ...
      <div className='flex flex-wrap justify-around px-20'>
        <div className='basis-1/2 flex justify-center p-6'><ProjectCard linkVideo ="tbd" title="Mon Portfolio" description="Si tu es arrivé.e jusque-là c'est que tu n'as pas besoin de description ;)" languages="tdb" linkCode="tdb"/></div>
