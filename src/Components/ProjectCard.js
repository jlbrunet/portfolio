...
const ProjectCard = (props) => {
  ...
  return (
    <div className='rounded-3xl bg-purple w-[18rem] md:w-[20rem] md:h-[35rem]'>
      {videoDisplayed && <div className='w-full h-48 md:h-[45%] relative opacity-50 transition-opacity duration-300 ease-in-out hover:opacity-100'>
      ...
      {!videoDisplayed && <div className='w-full h-48 md:h-[45%]'>
        {image}
      </div>}
      <div className='w-full h-72 md:h-[55%] px-5 m-auto flex flex-col justify-between'>
        <div>
          <p className='text-xl md:text-2xl py-3'><b>{title}</b></p>
