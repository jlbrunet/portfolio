...
const Footer = () => {
  ...
  return (
    <div className='w-full h-10 md:h-12 lg:h-20 text-beige bg-violet m-auto flex justify-around md:justify-center'>
      <div className='w-full md:w-1/2 h-full flex items-center justify-around lg:justify-between'>
        <div className='flex text-sm items-center lg:mx-16'>{t("footer.conception")}<div className='mx-2'>{<AiFillHeart />}</div>{t("footer.by")}</div>
